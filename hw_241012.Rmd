...
start_height <- c(10.5, 12.3, 9.8, 11.4, 13.1)  # Example heights
end_height <- c(12.0, 12.8, 10.1, 12.5, 13.0)   # Heights after one week
...
# Reformat to get height in one column and time as a factor
library(tidyr)
...
# Create a message about the growth status
growth_message <- "The plants show varying growth, with some positive and negative changes in height."
